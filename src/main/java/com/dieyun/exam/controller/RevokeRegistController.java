...
@RestController
@Slf4j
public class RevokeRegistController {

    @RequestMapping(value = "/revokeregist", method= RequestMethod.POST)
    public @ResponseBody
    Result revokeregist(HttpServletRequest request) {
